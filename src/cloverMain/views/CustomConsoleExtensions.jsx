				...
				: <>
					{currentCceId === null
						...
						: <>
							...
							<div className="cont-custom-console-extensions-resources"></div>
							{(()=>{
								iterate79.fnc({}, [
									function(it1){
										main.px2utils.px2cmd(
											...
											function( res ){
												...
												iterate79.ary(
													...
													function(it2, row, idx){
														...
														$('.cont-custom-console-extensions-resources').append(link);
														link.rel = 'stylesheet';
													...
													function(){
														iterate79.ary(
															...
															function(it3, row, idx){
																...
																$('.cont-custom-console-extensions-resources').append(script);
									...
									function(it1){
										...
										px2dthelperCceAgent = new Px2dthelperCceAgent({
											'elm': $('.cont-custom-console-extensions-main').get(0),
